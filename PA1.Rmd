...
```
Median Number of Steps per Day is **`r format(ttl.steps.by.date.median,big.mark=",",decimal.mark=".")`**
...
The **`r max.steps.interval`** interval contains on average the maximum number of steps (**`r format(max.steps,big.mark=",",decimal.mark=".")`** steps)
